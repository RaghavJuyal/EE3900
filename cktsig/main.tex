...
\begin{lstlisting}
https://github.com/RaghavJuyal/EE3900/blob/main/cktsig/codes/e3.cir
\end{lstlisting}
...
\begin{align}
	...
	H(s) = \frac{\frac{1}{R_2}}{\frac{1}{R_1} + \frac{1}{R_2} + sC_0} = \dfrac{1}{3 + 2sC_0}
	\label{eq:Hs}
\end{align}
...
\begin{align}
	...
	H(z) = \dfrac{1}{3 + 2C_0\dfrac{2}{T}\dfrac{z-1}{z+1}}
\end{align}
Putting T = 1 will give \eqref{eq:Hz}\\
\item Find $v(n)$. Verify using ngspice and differential equation\\
\solution\\
\begin{align}
	&V(z) = H(z)V_2(z)\\
	&= \dfrac{1}{3 +  \frac{4}{T}C_0 \frac{1 - z^{-1}}{1 + z^{-1}}}\frac{2}{1 - z^{-1}}\\
	&= \frac{2}{3}\brak{\frac{1}{1 + \frac{2\tau}{T}\frac{1 - z^{-1}}{1 + z^{-1}}}\frac{1}{1 - z^{-1}}}\\
	&= \frac{2}{3}\brak{\frac{1 + z^{-1}}{1 + z^{-1} + \frac{2\tau}{T}\brak{1 - z^{-1}}} \frac{1}{1 - z^{-1}}}\\
	&= \frac{2}{3}\brak{\frac{1}{1 - z^{-1}} - \frac{\frac{2\tau}{T}}{1 + z^{-1} + \frac{2\tau}{T}\brak{1 - z^{-1}}}}\\
	&= \frac{2}{3}\brak{\frac{1}{1 - z^{-1}} - \frac{\frac{2\tau}{T}}{1 + \frac{2\tau}{T} + z^{-1}\brak{1 - \frac{2\tau}{T}}}}\\
	&= \frac{2}{3}\brak{\frac{1}{1 - z^{-1}} - \frac{\frac{2\tau}{T}}{1 + \frac{2\tau}{T}} \frac{1}{1 - \brak{\frac{\frac{2\tau}{T} - 1}{\frac{2\tau}{T} + 1}} z^{-1}}}
\end{align}
Taking Inverse $\mathcal{Z}$ transform on both sides
\begin{align}
v(n) &= \frac{2}{3}u(n)\sbrak{1 - \frac{\frac{2\tau}{T}}{\frac{2\tau}{T} + 1}\brak{\frac{{ \frac{2\tau}{T} - 1}}{{\frac{2\tau}{T} + 1}}}^n}
\end{align}
\vspace{2.5cm}
\newline
